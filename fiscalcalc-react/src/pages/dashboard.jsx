                        ...
                        <div className="modal-content" onClick={(e) => e.stopPropagation()}>
                            ...
                            {itemTipo === "produto" && (
                                <div className="modal-body">
                                    ...
                                    <ul>
                                        {(Array.isArray(itemSelecionado.materiaPrima)
                                            ? itemSelecionado.materiaPrima
                                            : [itemSelecionado.materiaPrima]
                                        ).map((materia, index) => (
                                    ...
                                    <p><strong>Preço Unitário(R$):</strong> {Number(itemSelecionado.preco).toFixed(2)}</p>
                                    <p>
                                        <strong>Preço Total(R$):</strong>{" "}
                                        {(
                                            (Number(itemSelecionado.preco) || 0) *
                                            (parseFloat(itemSelecionado.quantidade) || 0)
                                        ).toFixed(2)}
                                    </p>
