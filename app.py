...
uri = "mongodb+srv://amandafgomes_db_user:krirPXsdMNvA7XUo@cluster0.oohzvht.mongodb.net/?appName=Cluster0"
client = MongoClient(uri)
db = client['midias']
fs = gridfs.GridFS(db)

st.title("Pratos feitos na hora, peça já o seu!")
...
if not arquivos:
    ...
    for i, arquivo in enumerate(arquivos):
        ...
        with cols[i % 3]:
            st.image(imagem, caption=arquivo.filename)
